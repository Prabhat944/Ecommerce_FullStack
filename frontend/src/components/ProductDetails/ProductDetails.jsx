                                ...
                                <div className="flex flex-col gap-2 mb-4">
                                    ...
                                    {Array(3).fill("").map((el, i) => (
                                        <p className="text-sm flex items-center gap-1" key={i}>
                                            ...
                                            <span className="font-medium ml-2">Bank Offer</span> 15% Instant discount on first Edenzos Pay Later order of 500 and above <Link className="text-primary-pink font-medium" to="/">T&C</Link>
                                        </p>
                                    ))}
                                    {/* <!-- banks offers --> */}
                                    ...
                                    <div className="flex gap-8 mt-2 items-center text-sm">
                                        ...
                                        <span>{product.warranty} Year Warranty <Link className="font-medium text-primary-pink" to="/">Know More</Link></span>
                                    </div>
                                    {/* <!-- warranty & brand --> */}
                                    ...
                                    <div className="flex flex-col sm:flex-row justify-between">
                                        ...
                                        <div className="flex gap-16 mt-4 mr-6 items-stretch text-sm">
                                            ...
                                            <ul className="flex flex-col gap-2">
                                                <li>
                                                    <p className="flex items-center gap-3"><span className="text-primary-pink"><VerifiedUserIcon sx={{ fontSize: "18px" }} /></span> {product.warranty} Year</p>
                                                </li>
                                                <li>
                                                    <p className="flex items-center gap-3"><span className="text-primary-pink"><CachedIcon sx={{ fontSize: "18px" }} /></span> 7 Days Replacement Policy</p>
                                                </li>
                                                <li>
                                                    <p className="flex items-center gap-3"><span className="text-primary-pink"><CurrencyRupeeIcon sx={{ fontSize: "18px" }} /></span> Cash on Delivery available</p>
                                                </li>
                                            </ul>
                                        </div>
                                        {/* <!-- services details --> */}
                                    ...
                                    <div className="flex gap-16 mt-4 items-center text-sm font-medium">
                                        ...
                                        <Link className="font-medium text-primary-pink ml-3" to="/">{product.brand && product.brand.name}</Link>
                                    </div>
                                    {/* <!-- seller details --> */}
                                    ...
                                    <div className="w-full mt-4 rounded-sm border flex flex-col">
                                        ...
                                        {product.reviews?.length > 3 &&
                                            <button onClick={() => setViewAll(!viewAll)} className="w-1/3 m-2 rounded-sm shadow hover:shadow-lg py-2 bg-primary-pink text-white">{viewAll ? "View Less" : "View All"}</button>
                                        }
                                    </div>
                                    {/* <!-- reviews border box --> */}
