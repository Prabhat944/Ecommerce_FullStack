    ...
    const navs = [
        {
            ...
            redirect: "https://www.Edenzos.com/communication-preferences/push",
        },
        {
            title: "Sell on Edenzos",
            icon: <BusinessCenterIcon sx={{ fontSize: "18px" }} />,
            redirect: "https://seller.Edenzos.com/sell-online",
        },
        {
        ...
        },
        {
            ...
            redirect: "https://advertising.Edenzos.com",
        },
        {
            title: "Download App",
            icon: <DownloadIcon sx={{ fontSize: "18px" }} />,
            redirect: "https://www.Edenzos.com/mobile-apps",
        },
    ]
            ...
            {navs.map((item, i) => {
                ...
                return (
                    <a className="pl-3 py-3.5 border-b flex gap-3 items-center hover:bg-gray-50 rounded-t" href={redirect} key={i}>
                        <span className="text-primary-pink">{icon}</span>
                        {title}
                    </a>
                )
            })}
