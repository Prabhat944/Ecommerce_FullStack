                            ...
                            <div className="flex-1 overflow-hidden shadow bg-white">
                                ...
                                <div className="flex flex-col gap-12 m-4 sm:mx-8 sm:my-6">
                                    ...
                                    <div className="flex flex-col gap-5 items-start">
                                        <span className="font-medium text-lg">Personal Information <Link to="/account/update" className="text-sm text-primary-pink font-medium ml-8 cursor-pointer">Edit</Link></span>
                                    ...
                                    <div className="flex flex-col gap-5 items-start">
                                        <span className="font-medium text-lg">Email Address
                                            <Link to="/account/update" className="text-sm text-primary-pink font-medium ml-3 sm:ml-8 cursor-pointer">Edit</Link>
                                            <Link to="/password/update" className="text-sm text-primary-pink font-medium ml-3 sm:ml-8">Change Password</Link>
                                        </span>
                                    ...
                                    <div className="flex flex-col gap-5 items-start">
                                        <span className="font-medium text-lg">Mobile Number
                                            <span className="text-sm text-primary-pink font-medium ml-3 sm:ml-8 cursor-pointer" id="mobEditBtn">Edit</span>
                                        </span>
                                    ...
                                    <div className="flex flex-col gap-4 mt-4">
                                        ...
                                        <h4 className="text-sm font-medium">When will my Edenzos account be updated with the new email address (or mobile number)?</h4>
                                        ...
                                        <h4 className="text-sm font-medium">What happens to my existing Edenzos account when I update my email address (or mobile number)?</h4>
                                        ...
                                        <p className="text-sm">Edenzos has a 'single sign-on' policy. Any changes will reflect in your Seller account also.</p>

                                    </div>
                                    {/* <!-- faqs --> */}

                                    {/* <!-- deactivate account --> */}
                                    <Link className="text-sm text-primary-pink font-medium" to="/">Deactivate Account</Link>
                                    {/* <!-- deactivate account --> */}
                                </div>
                                {/* <!-- edit info container --> */}
