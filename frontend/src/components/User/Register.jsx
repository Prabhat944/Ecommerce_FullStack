...
const Register = () => {
    ...
    return (
        <>
            <MetaData title="Register | Edenzos" />
                    ...
                    <div className="flex-1 overflow-hidden">
                        ...
                        >
                            <div className="flex flex-col gap-4 items-start">
                                ...
                                <Link to="/login" className="hover:bg-gray-50 text-primary-pink text-center py-3 w-full shadow border rounded-sm font-medium">Existing User? Log in</Link>
                            </div>
