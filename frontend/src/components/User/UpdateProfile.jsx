...
const UpdateProfile = () => {
    ...
    return (
        <>
            <MetaData title="Update Profile | Edenzos" />
            ...
            <main className="w-full mt-12 sm:pt-20 sm:mt-0">
                ...
                <div className="flex sm:w-4/6 sm:mt-4 m-auto mb-7 bg-white shadow-lg">
                    {/* <!-- sidebar column  --> */}
                    <div className="loginSidebar bg-primary-pink px-9 py-10 hidden sm:flex flex-col gap-4 w-2/5">
                    ...
                    <div className="flex-1 overflow-hidden">
                        ...
                        >
                            <div className="flex flex-col gap-4 items-start">
                                ...
                                <Link className="hover:bg-gray-100 text-primary-pink text-center py-3 w-full shadow border rounded-sm font-medium" to="/account">Cancel</Link>
                            </div>
